...
const connectWebSocket = () => {
  ...
  ws.value.onopen = () => {
    ws.value.send(JSON.stringify({
      op: 2,
      d: { subscribe_to_id: '689494773610053708' }
    }));
  };
...
<template>
  ...
  <div>
    baki, 18 years-old. cloud developer, student. tame impala enjoyer. 
    books, music, math.
  </div>
  ...
  <div class="flex gap-10 mt-5 text-xl">
    <a href="https://github.com/Ayuki/" target="_blank" class="flex items-center justify-center">
      <font-awesome-icon :icon="['fab', 'github']" class="w-5 h-5" />
    </a>
    <a href="https://www.instagram.com/bakicore" target="_blank" class="flex items-center justify-center">
      <font-awesome-icon :icon="['fab', 'instagram']" class="w-5 h-5" />
    </a>
    <a href="https://discord.com/user/689494773610053708" target="_blank" class="flex items-center justify-center">
